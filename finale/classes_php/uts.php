...
<head>
    ...
    <title>Class 6: Understanding the Self</title>
...
<body>
    ...
    <section class="hero">
        ...
        <p>Understanding the self involves exploring one's identity, thoughts, emotions, behaviors, and relationships to gain self-awareness and personal growth.</p>
    ...
    <script>
        const pdfUrl = 'classes.uts.pdf';  // Path to the certificate PDF file
