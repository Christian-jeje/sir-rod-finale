...
<head>
    ...
    <title>Class 7: Mathematics in the Modern World</title>
...
<body>
    ...
    <section class="hero">
        ...
        <p>Mathematics in the modern world is essential for solving real-life problems, driving technological advancements, and supporting decision-making across various fields.</p>
    ...
    <script>
        const pdfUrl = 'classes/Mathematics-for-the-Modern-World-1.pdf';  // Path to the certificate PDF file
