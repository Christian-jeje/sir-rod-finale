...
<head>
    ...
    <title>Class 5: Purposive Communication</title>
...
<body>
    ...
    <section class="hero">
        ...
        <p>Purposive communication is the intentional use of language and messages to achieve specific goals or convey meaning effectively in various contexts.</p>
    ...
    <script>
        const pdfUrl = 'classes/pc.pdf';  // Path to the certificate PDF file
