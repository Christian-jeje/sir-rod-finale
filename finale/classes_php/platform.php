...
<head>
    ...
    <title>Class 4:Platform Technologies</title>
    <style>
        body {
            margin: 0;
...
<body>
    ...
    <section class="hero">
        ...
        <p>Platform technologies provide the foundational tools and infrastructure that enable the development, integration, and scaling of various applications and services across different industries.</p>
    ...
    <script>
        const pdfUrl = 'classes/platform.pdf';  // Path to the certificate PDF file
