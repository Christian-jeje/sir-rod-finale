...
<body>
    ...
    <section class="hero">
        <h1>Binary</h1>
        <p>It is a base-2 number system using only 0 and 1 to represent data.</p>
    ...
    <script>
        const pdfUrl = 'classes/binary.pdf';  // Path to the certificate PDF file
