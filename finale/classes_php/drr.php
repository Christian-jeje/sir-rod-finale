...
<head>
    ...
    <title>Class 8: Disaster Risk Reduction</title>
...
<body>
    ...
    <section class="hero">
        ...
        <p>It focuses on minimizing disaster impacts by enhancing preparedness, resilience, and sustainable development practices.</p>
    ...
    <script>
        const pdfUrl = 'classes/dr1.pdf';  // Path to the certificate PDF file
